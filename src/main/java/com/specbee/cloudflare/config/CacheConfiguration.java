package com.specbee.cloudflare.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("cloudflare");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("cloudflare");
        ...
        config.getMapConfigs().put("com.specbee.cloudflare.domain.*", initializeDomainMapConfig(jHipsterProperties));
